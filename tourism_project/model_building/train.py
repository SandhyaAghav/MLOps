...
Xtrain_path = "hf://datasets/Sandhya-2025/tourism-package-purchase/Xtrain.csv"
Xtest_path = "hf://datasets/Sandhya-2025/tourism-package-purchase/Xtest.csv"
ytrain_path = "hf://datasets/Sandhya-2025/tourism-package-purchase/ytrain.csv"
ytest_path = "hf://datasets/Sandhya-2025/tourism-package-purchase/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_product_purchase_model_v1.joblib"
    ...
    repo_id = "Sandhya-2025/product-purchase-model"
    repo_type = "model"
    ...
    # create_repo("purchase-prediction-model", repo_type="model", private=False)
    api.upload_file(
        path_or_fileobj="best_product_purchase_model_v1.joblib",
        path_in_repo="best_product_purchase_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
