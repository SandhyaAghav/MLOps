...
model_path = hf_hub_download(repo_id="Sandhya-2025/product_purchase_model", filename="best_product_purchase_model_v1.joblib")
...
if st.button("Predict"):
    ...
    result = "purchase product" if prediction == 1 else "not purchase product"
